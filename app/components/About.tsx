  ...
  return (
    <section ref={ref} className="pt-[150px]" id="about">
      <AnimatedTitle
        ...
        className={`uppercase ${syne.className} antialiased text-6xl font-bold opacity-80`}
      >
        I amplify brand voices through the web
      </AnimatedTitle>

      <div className="grid grid-cols-[8.5fr_3.5fr] gap-8 mt-6">
        <div className="grid grid-cols-1 antialiased gap-6 text-white/80 text-2xl">
          <AnimatedBody className="leading-[39px]">
          ...
          <AnimatedBody className="inline leading-[39px]">
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            <AnimatedTitle
              wordSpace={"mr-[0.5ch]"}
              charSpace={"mr-[0.001em]"}
              className="font-bold antialiased text-2xl mb-2"
            >
              Frontend Tools
            </AnimatedTitle>
            <AnimatedBody className="text-white/60 text-xl leading-8">
